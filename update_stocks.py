...
NEW_CONTENT = '''import yfinance as yf
import time
import threading
...
STATIC_STOCKS = [
    ...
    {"t": "LTIM", "n": "LTIMindtree", "sec": "Technology", "ind": "IT Services", "rat": "Buy", "tgt": 6500, "pros": ["Merger synergies", "Strong execution track record"], "cons": ["Integration challenges", "Client concentration"]},
    ...
    {"t": "TATAMOTORS", "n": "Tata Motors", "sec": "Automobile", "ind": "Auto Maker", "rat": "Strong Buy", "tgt": 1100, "pros": ["EV leader in India", "JLR debt reduction"], "cons": ["Cyclical CV business"]},
...
with open('d:/Screener/backend/stock_data.py', 'w') as f:
    f.write(NEW_CONTENT)
print("Updated stock_data.py")
